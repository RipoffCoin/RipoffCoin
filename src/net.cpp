...
void ThreadSocketHandler()
{
    ...
    loop
    {
        ...
        timeout.tv_sec  = 0;
        timeout.tv_usec = 54011; // frequency to poll pnode->vSend
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RipoffCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"main seed", "seed.ripoffcoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"Testnet Seed", "seedtest.ripoffcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RipoffCoin is probably already running."), addrBind.ToString().c_str());
        else
